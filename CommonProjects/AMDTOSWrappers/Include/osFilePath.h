...
public:
    ...
    /// \param[in] extensionsStr - string containing all possible extensions of specific platform kernels|shaders
    /// \return true if current file extension is found in the list
    bool IsMatchingExtension(const gtString& pPlatformFilesExtensions) const;
