...
// Date:        25/8/2005
// ---------------------------------------------------------------------------
bool osNULLSocket::write(const gtByte* pDataBuffer, gtSize_t dataSize)
{
...
// Date:        10/2/2008
// ---------------------------------------------------------------------------
bool osNULLSocket::readAvailableData(gtByte* pDataBuffer, gtSize_t bufferSize, gtSize_t& amountOfDataRead)
{
    (void)(pDataBuffer); // unused
