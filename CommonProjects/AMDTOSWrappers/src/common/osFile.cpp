...
// Date:        2/8/2004
// ---------------------------------------------------------------------------
bool osFile::write(const gtByte* pDataBuffer, gtSize_t dataSize)
{
    bool retVal = false;
...
// Date:        7/9/2010
// ---------------------------------------------------------------------------
bool osFile::writeString(const gtString& str)
{
    bool retVal = false;
...
// Date:        24/8/2005
// ---------------------------------------------------------------------------
bool osFile::read(gtByte* pDataBuffer, gtSize_t dataSize)
{
...
// Date:        7/9/2010
// ---------------------------------------------------------------------------
bool osFile::readString(gtString& str)
{
    (void)(str); // unused
    return false;
}
...
// Date:        24/8/2005
// ---------------------------------------------------------------------------
bool osFile::readAvailableData(gtByte* pDataBuffer, gtSize_t bufferSize, gtSize_t& amountOfDataRead)
{
    bool retVal = false;
