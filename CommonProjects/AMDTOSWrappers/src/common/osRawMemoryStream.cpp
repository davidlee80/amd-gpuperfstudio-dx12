...
// Date:        4/5/2004
// ---------------------------------------------------------------------------
bool osRawMemoryStream::write(const gtByte* pDataBuffer, gtSize_t dataSize)
{
    bool rc = true;
...
// Date:        4/5/2004
// ---------------------------------------------------------------------------
bool osRawMemoryStream::read(gtByte* pDataBuffer, gtSize_t dataSize)
{
    bool retVal = false;
...
// Date:        10/2/2008
// ---------------------------------------------------------------------------
bool osRawMemoryStream::readAvailableData(gtByte* pDataBuffer, gtSize_t bufferSize, gtSize_t& amountOfDataRead)
{
    bool retVal = true;
    amountOfDataRead = 0;
