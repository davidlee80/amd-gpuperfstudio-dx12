...
// Date:        20/2/2007
// ---------------------------------------------------------------------------
bool osLaunchFileInCurrentThread(const gtString& fileToBeLaunched)
{
    bool retVal = false;
        ...
        if (0 == childOfChildProcessId)
        {
            ...
            else
            {
                ...
                else if (desktopType == OS_KDE_DESKTOP)
                {
                    ...
                    const char* commandArgsKDE[] = { "kfmclient", "openURL", utf8FileToBeLaunched.c_str(), 0 };
            ...
            const char* commandArgs[] = {"open", utf8FileToBeLaunched.c_str(), NULL};
...
bool osFileLauncher::launchFile()
{
    ...
    else
    {
        ...
        retVal = osLaunchFileInCurrentThread(_fileToBeLaunched);
    }
