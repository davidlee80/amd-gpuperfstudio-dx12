...
bool osGetLocalMachineMemoryInformationStrings(gtString& totalRam, gtString& availRam, gtString& totalPage, gtString& availPage, gtString& totalVirtual, gtString& availVirtual)
{
    ...
    gtUInt64 totalRamUInt = physicalMemData._totalPhysicalMemory / 1024 / 1024;
    gtUInt64 availRamUInt = physicalMemData._freePhysicalMemory / 1024 / 1024;
    gtUInt64 totalPageUInt = physicalMemData._totalSwapMemory / 1024 / 1024;
    gtUInt64 availPageUInt = physicalMemData._freeSwapMemory / 1024 / 1024;
    gtUInt64 totalVirtualUInt = physicalMemData._totalVirtualMemory / 1024 / 1024;
    gtUInt64 availVirtualUInt = physicalMemData._freeVirtualMemory / 1024 / 1024;
