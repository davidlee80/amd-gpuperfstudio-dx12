...
// ---------------------------------------------------------------------------
bool osPipeSocket::write(const gtByte* pDataBuffer, gtSize_t dataSize)
{
    bool retVal = false;
...
// ---------------------------------------------------------------------------
bool osPipeSocket::read(gtByte* pDataBuffer, gtSize_t dataSize)
{
...
// Date:        10/2/2008
// ---------------------------------------------------------------------------
bool osPipeSocket::readAvailableData(gtByte* pDataBuffer, gtSize_t bufferSize, gtSize_t& amountOfDataRead)
{
