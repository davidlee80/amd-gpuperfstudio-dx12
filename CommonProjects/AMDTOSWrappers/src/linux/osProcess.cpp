...
osFilePath g_codeXLExecutionPath;

void osSetCodeXLExecutionPath(const osFilePath& codeXLExecutionPath)
{
    g_codeXLExecutionPath = codeXLExecutionPath;
}
...
void osRemoveRuntimeLibsPathFromLibraryPath()
{
    ...
    osFilePath codeXLPath(g_codeXLExecutionPath);
    ...
    codeXLPath = g_codeXLExecutionPath;
