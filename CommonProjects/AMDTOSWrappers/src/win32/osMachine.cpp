...
bool osGetLocalMachineMemoryInformationStrings(gtString& totalRam, gtString& availRam, gtString& totalPage, gtString& availPage, gtString& totalVirtual, gtString& availVirtual)
{
    ...
    totalPageSizet = stMemStatus.ullTotalPageFile;
    ...
    availPageSizet = stMemStatus.ullAvailPageFile;
    ...
    totalVirtualSizet = stMemStatus.ullTotalVirtual;
    ...
    availVirtualSizet = stMemStatus.ullAvailVirtual;
