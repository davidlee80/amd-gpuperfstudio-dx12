...
////////////////////////////////////////////////////////////////////////////////////////////
void HTTPRequestHeader::SetClientSocket(NetSocket* clientSocket)
{
    m_httpHeaderData.client_socket = clientSocket;
}
...
/// \return a NetSocket*
////////////////////////////////////////////////////////////////////////////////////////////
NetSocket* HTTPRequestHeader::GetClientSocket()
{
    return m_httpHeaderData.client_socket;
}
...
////////////////////////////////////////////////////////////////////////////////////////////
HTTP_REQUEST_RESULT HTTPRequestHeader::ReadWebRequest(string& strError)
{
    gtSize_t nRead = 0;
    ...
    nRead = SocketReadHeader(GetClientSocket(), readBuffer, COMM_BUFFER_SIZE);

    // Check for error
    if (nRead == 0 || nRead == (gtSize_t) - 1)
    {
        strError = "HTTPRequestHeader: SocketReadHeader failed.";
    ...
    if (GetPostDataSize() > 0)
    {
        ...
        bRes = ReadPostData(strError, false, emptyString);
...
/// \Return True if success, False if fail.
////////////////////////////////////////////////////////////////////////////////////////////
bool HTTPRequestHeader::ReadPostData(string& strError, bool bUseSharedMemory, const char* pSharedMemoryName)
{
    ...
    if (bUseSharedMemory == false)
    {
        // Read data from a socket
        nRead = SocketRead(GetClientSocket(), m_pPostData, nContentLength);
    }
    else
    {
