...
/// \file
/// \brief  File contains the declaration of the FrameProfiler class which should
///         be utilized by all plugins.TODO add description
//==============================================================================
...
public:
    ...
    /// \param pcsMesage the message to send back
    /// \nSize the size of messages stored
...
protected:
    ...
    //-----------------------------------------------------------------------------
    bool LoadProfilerDLL(GPA_SUPPORTED_API api);
