...
#if defined (_WIN32)
    #define PS_UNREFERENCED_PARAMETER(p) (p)
#else
    #define PS_UNREFERENCED_PARAMETER(p) (void)(p)
#endif

#ifdef GPS_PLUGIN_EXPORTS
    #define GPS_PLUGIN_API extern "C" __declspec( dllexport )
#elif defined GPS_PLUGIN_STATIC
    #define GPS_PLUGIN_API extern "C" __attribute__ ((visibility ("default")))
#else
    #define GPS_PLUGIN_API extern "C" __declspec( dllimport )
#endif
...
///////////////////////////////////////////////////////////////////////////////////////////
/// Simple CRC class. It will generate a CRC for any input data.
///////////////////////////////////////////////////////////////////////////////////////////
class CRC : public TSingleton< CRC >
{
    friend class TSingleton< CRC >;

    static const UINT64 CrcPoly64 = 0xE060034000F0D50BULL;  ///< CRC polynomial
    static const UINT32 CrcTableSize = 256;                 ///< CRC table size.  Has to be a power of 2 to work

    UINT64 m_crcTable[CrcTableSize];    ///< Lookup table used in computing CRC
...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////
    /// Get a CRC for the input data.
    /// \param pData The input data
    /// \param dataSize The size of the input data
    ///////////////////////////////////////////////////////////////////////////////////////////
    UINT64 GetCrc(const char* pData, UINT32 dataSize)      ///< [in] pointer to shader code
    {
        ...
        if (pData != NULL)
        {
            while (dataSize-- > 0)
            {
                crc = (crc >> 8) ^ m_crcTable[(crc ^ *pData++) & (CrcTableSize - 1)];
            }
        }
        else
        {
