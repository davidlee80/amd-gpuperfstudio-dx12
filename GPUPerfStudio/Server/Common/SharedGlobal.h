...
/// \file
/// \brief  Shared Globals mechanism for PerfStudio
//==============================================================================
...
#define SG_GET_PATH(data) SharedGlobal::Instance()->GetPath(offsetof(struct PsSharedGlobal, data))
#define SG_SET_PATH(data, path) SharedGlobal::Instance()->SetPath(offsetof(struct PsSharedGlobal, data), path)

#define SG_GET_BOOL(data) SharedGlobal::Instance()->GetValue<bool>(offsetof(struct PsSharedGlobal, data))
#define SG_SET_BOOL(data, value) SharedGlobal::Instance()->SetValue<bool>(offsetof(struct PsSharedGlobal, data), value)

#define SG_GET_INT(data) SharedGlobal::Instance()->GetValue<int32>(offsetof(struct PsSharedGlobal, data))
#define SG_SET_INT(data, value) SharedGlobal::Instance()->SetValue<int>(offsetof(struct PsSharedGlobal, data), value)

#define SG_GET_UINT(data) SharedGlobal::Instance()->GetValue<uint32>(offsetof(struct PsSharedGlobal, data))
#define SG_SET_UINT(data, value) SharedGlobal::Instance()->SetValue<unsigned int>(offsetof(struct PsSharedGlobal, data), value)

#define SG_GET_FLOAT(data) SharedGlobal::Instance()->GetValue<float>(offsetof(struct PsSharedGlobal, data))
#define SG_SET_FLOAT(data, value) SharedGlobal::Instance()->SetValue<float>(offsetof(struct PsSharedGlobal, data), value)

#define FLAG_BUILD_INTERNAL   0x01
#define FLAG_BUILD_32BIT      0x02
