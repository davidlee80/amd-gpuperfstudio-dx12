...
//-----------------------------------------------------------------------------
/// Closes the socket AND DELETES THE INSTANCE
//-----------------------------------------------------------------------------
...
/// \param checkForRead true if checking read status, false to check write
/// status
/// returns true if OK, false if no sockets available or socket error
//-----------------------------------------------------------------------------
