...
static const char* s_mutexName = "PerfStudioLogfileMutex";
...
// This function is only called once per invocation of the PerfStudio server and forces the overwriting of
...
#define PS_LOG_MAX_LENGTH 1024
#define PS_LOG_INDENT_SIZE 4
