...
#define STR_STREAM_TOKEN "?Stream="

#include <AMDTBaseTools/Include/gtASCIIString.h>

#ifdef _WIN32
    typedef size_t  CommunicationID;
#else
    // CommunicationID needs to be the same size as a native pointer on Linux
    typedef unsigned long CommunicationID;
#endif
