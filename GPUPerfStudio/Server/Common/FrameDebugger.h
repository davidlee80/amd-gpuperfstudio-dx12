...
/// \file
/// \brief  the API-agnostic FrameDebugger base class which
///         should be inherited from for API-specific implementations
//==============================================================================
...
public:
    ...
    unsigned long GetBreakPoint() { return m_dwBreakPoint; }
