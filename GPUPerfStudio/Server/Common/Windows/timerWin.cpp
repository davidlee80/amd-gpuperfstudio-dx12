...
static LONGLONG s_TimeQPCCurrent = (LONGLONG)0;
static DWORD s_TimeGTCCurrent = 0;
static DWORD s_TimeTGTCurrent = 0;

static LONGLONG s_TimeQPCPrevious = (LONGLONG)0;
static DWORD s_TimeGTCPrevious = 0;
static DWORD s_TimeTGTPrevious = 0;

static LONGLONG s_TimeQPCIni = (LONGLONG)0;
static DWORD s_TimeGTCIni = 0;
static DWORD s_TimeTGTIni = 0;

static LONGLONG s_TimeQPCFin = (LONGLONG)0;
static DWORD s_TimeGTCFin = 0;
static DWORD s_TimeTGTFin = 0;

static LONGLONG s_TimeQPCFrozen = (LONGLONG)0;
static DWORD s_TimeGTCFrozen = 0;
static DWORD s_TimeTGTFrozen = 0;
...
///
/// \param the output of QueryPerformanceCounter()
///
