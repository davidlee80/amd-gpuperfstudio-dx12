...
/// \file
/// \brief  TODO add documentation ICommunication interface
//==============================================================================
...
// typedefs for RequestMap and ResponseMap, this makes declaring
...
// instances of a RequestMap and ResponseMap that are used for storage
...
//=============================================================================
void CloseConnection(Response& rResponse);
...
//-----------------------------------------------------------------------------
/**  MakeResponse
* Creates or aquires a response (and socket) needed to send data the specified
* requestID
* \param requestID id of the request to create a response for
* \param ppResponse [out] pointer to a Response pointer; if MakeResponse returns true, then it will point to the new or existing response for the requestID
...
//-----------------------------------------------------------------------------
bool SendBufferResponse(CommunicationID& requestID)
{
    return SendBinaryResponse(requestID, g_pBufferedResponse, g_uBufferedResponseSize);
}
...
/// \return true if the response could be sent; false otherwise
//-----------------------------------------------------------------------------
bool SendHTMLResponse(CommunicationID& requestID, const char* cpData)
{
    if (cpData == NULL)
    {
...
/// \return true if the response could be sent; false otherwise
//-----------------------------------------------------------------------------
bool SendXMLResponse(CommunicationID& requestID, const char* cpData)
{
    if (cpData == NULL)
    {
...
///
/// \param rRequest the request that was received over a socket
