...
static std::map< gtASCIIString, SharedMemoryManager* >* g_sharedMemoryMap = NULL;
...
//=============================================================================
bool smPut(const char* strName, void* in, unsigned long dwNumBytes)
{
    PsAssert(strName != NULL);
    SharedMemoryManager* pSM = GetSM(strName);
...
/// \param pOut buffer that the data in the shared memory should be copied into
/// \param dwBufferSize maximum number of bytes to copy into the previous buffer
///
