...
/// \param inDxgiFormat A D3D12_PRIMITIVE_TOPOLOGY enum to stringify.
...
//--------------------------------------------------------------------------
gtASCIIString& WriteDXGISampleDesc(const DXGI_SAMPLE_DESC inStruct, gtASCIIString& ioSerializedStructure, const char* inOptionalNameAttribute = NULL);
};
