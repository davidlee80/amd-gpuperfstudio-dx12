...
//--------------------------------------------------------------------------
IDX12InstanceBase::IDX12InstanceBase(IUnknown* inRuntimeInstance, IUnknown* inWrapperInterface, eObjectType inObjectType, GPS_DX12CreateInfoBase* inCreateInfo)
...
const char* IDX12InstanceBase::GetTypeAsString() const
{
    ...
    switch (mObjectType)
    {
        ...
        default:                                            objectTypeString = NULL;
    }

    PsAssert(objectTypeString != NULL);
